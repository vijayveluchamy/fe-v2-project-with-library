...
// Provides control com.myorg.library1.Example.
...
/**
 * Constructor for a new <code>com.myorg.library1.Example</code> control.
 *
 ...
 * @constructor
 * @public
 * @name com.myorg.library1.Example
 */
export default class Example extends Control {
	...
	static readonly metadata = {
		...
		properties: {
			 ...
			 */
			color: {
				type: "com.myorg.library1.ExampleColor",
				group: "Appearance",
